...
function renderItems(items, onDismiss, onPause, onResume) {
  ...
  var notifs = items.map(function (msg) {
    ...
    }, _react.default.createElement(Notif, (0, _extends2.default)({
      key: msg.id,
      msg: msg
    }, notifProps)));
  });
  return _react.default.createElement(_reactTransitionGroup.TransitionGroup, null, notifs);
